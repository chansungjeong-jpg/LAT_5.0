...
<section class="panel"><table><thead><tr><th>순위</th><th>종목</th><th>위치점수</th><th>상태</th><th>매수</th><th>거래량</th><th>일봉 5선 이격</th><th>일봉 RSI</th><th>60분 RSI</th><th>손익비</th><th>차단 사유</th></tr></thead><tbody>__ROWS__</tbody></table></section>
<div class="note">점수 순위는 분석용입니다. Hard Block과 매수 가능 여부를 반드시 함께 확인하세요. RSI는 보조 관찰값이며 점수·게이트에 사용하지 않습니다.</div>
</main></body></html>"""
        ...
        .replace("__ROWS__", "\n".join(rendered_rows) or '<tr><td colspan="11">데이터 없음</td></tr>'),
        encoding="utf-8",
    )
    return output_path
